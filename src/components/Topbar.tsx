...
import { useAppStore, useTabTitle } from '../store/useAppStore'
...
export default function Topbar() {
  ...
  const title = useTabTitle(activeTab)
  ...
  return (
    <header className="topbar" id="dashboard-topbar">
      ...
      <div className="topbar-right">
        ...
        <button className="btn btn-primary" id="btn-new-project" onClick={() => setOpenModal('newProject')}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
