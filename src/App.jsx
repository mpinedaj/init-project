    ...
    <>
      ...
      <nav className="navbar" id="navbar">
        <div className="navbar-inner">
          ...
          <div className="navbar-actions">
            <button className="btn btn-ghost" id="btn-login">Iniciar sesión</button>
            <button className="btn btn-primary" id="btn-signup">Empieza gratis</button>
          </div>
        </div>
      </nav>
      ...
      <section className="hero" id="hero">
        <div className="hero-content">
          ...
          <div className="hero-actions">
            <button className="btn btn-primary btn-lg" id="hero-cta-primary">
      ...
      <section className="section" id="pricing">
        ...
        <div className="pricing-grid">
          ...
          <div className="pricing-card animate-on-scroll" id="pricing-free">
            ...
            <button className="btn btn-outline btn-lg" style={{ width: '100%' }} id="free-cta">
              Empezar gratis
            </button>
          </div>
          ...
          <div className="pricing-card featured animate-on-scroll" id="pricing-pro">
            ...
            <button className="btn btn-primary btn-lg" style={{ width: '100%' }} id="pro-cta">
      ...
      <section className="section cta-section" id="cta">
        <div className="cta-box animate-on-scroll">
          ...
          <button className="btn btn-primary btn-lg" id="cta-final">
